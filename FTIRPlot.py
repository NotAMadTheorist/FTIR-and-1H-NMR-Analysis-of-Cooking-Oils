...
colors_NMRSamples = ['#f34f1c', '#5284bd', '#dba207','#80ba06']
...
spacing = 0.15
linewidth = 0.8
for fullName, color, percentCanola, DFSample in zip(fullNames_FTIRSamples, colors_NMRSamples, percentCanola_FTIRSamples,
                                                    DF_FTIRSamples):
...
linewidth = 0.8
spacing = 0.15
for shortName, color, percentCanola, DFSample in zip(names_FTIRSamples, colors_NMRSamples, percentCanola_FTIRSamples,
                                                    DF_FTIRSamples):
    wavenumberCol = DFSample["Wavenumber"]
    transmittanceCol = DFSample["Percent Transmittance"]
