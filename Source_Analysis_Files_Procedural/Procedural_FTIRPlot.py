...
from Source_FTIR_HNMR.rootDir import (path_FTIRCanolaOil, path_FTIRPalmOil, path_FTIR2C1PMix, path_FTIR1C2PMix,
                                      path_OutFTIR_CorrelProc)
...
DFPeakCorrelation.to_csv(path_OutFTIR_CorrelProc, index=False)
